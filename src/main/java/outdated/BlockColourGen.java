...
//  }
//
//  public static int calculateBlockAndMeta(final Block block, final int metadata) {
//    return calculateBlockAndMeta(Block.getIdFromBlock(block), metadata);
//  }
//
//  public static int calculateBlockAndMeta(final int blockID, final int metadata) {
//    return ((blockID & 0xfff) << 4) | (metadata & 0xf);
//  }
//
...
//
//        int blockAndMeta = calculateBlockAndMeta(blockID, dv);
//        Block block = (Block) Block.blockRegistry.getObjectById(blockID);
//        int blockColour = 0;
//
//        if (block != null) {
