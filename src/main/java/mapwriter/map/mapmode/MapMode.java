...
public class MapMode {
  ...
  public void loadConfig() {
    final MwConfig config = Config.instance.getConfigFile();
    config.load();
    // get options from config file
    this.enabled = config.getOrSetBoolean(this.configCategory, "enabled", this.enabled);
    this.playerArrowSize = config.getOrSetInt(this.configCategory, "playerArrowSize", this.playerArrowSize, 1, 20);
    this.markerSize = config.getOrSetInt(this.configCategory, "markerSize", this.markerSize, 1, 20);
    this.alphaPercent = config.getOrSetInt(this.configCategory, "alphaPercent", this.alphaPercent, 0, 100);

    this.heightPercent = config.getOrSetInt(this.configCategory, "heightPercent", this.heightPercent, 0, 100);
    this.marginTop = config.getOrSetInt(this.configCategory, "marginTop", this.marginTop, -1, 320);
    this.marginBottom = config.getOrSetInt(this.configCategory, "marginBottom", this.marginBottom, -1, 320);
    this.marginLeft = config.getOrSetInt(this.configCategory, "marginLeft", this.marginLeft, -1, 320);
    this.marginRight = config.getOrSetInt(this.configCategory, "marginRight", this.marginRight, -1, 320);

    this.rotate = config.getOrSetBoolean(this.configCategory, "rotate", this.rotate);
    this.circular = config.getOrSetBoolean(this.configCategory, "circular", this.circular);
    this.coordsEnabled = config.getOrSetBoolean(this.configCategory, "coordsEnabled", this.coordsEnabled);
    this.borderMode = config.getOrSetInt(this.configCategory, "borderMode", this.borderMode, 0, 1);
  ...
  public void saveConfig() {
    final MwConfig config = Config.instance.getConfigFile();
    config.setBoolean(this.configCategory, "enabled", this.enabled);
    config.setInt(this.configCategory, "heightPercent", this.heightPercent);
    config.setInt(this.configCategory, "marginTop", this.marginTop);
    config.setInt(this.configCategory, "marginBottom", this.marginBottom);
    config.setInt(this.configCategory, "marginLeft", this.marginLeft);
    config.setInt(this.configCategory, "marginRight", this.marginRight);
    config.setBoolean(this.configCategory, "rotate", this.rotate);
    config.setBoolean(this.configCategory, "circular", this.circular);
    config.save();
  }
